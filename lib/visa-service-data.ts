...
export const visaServices: VisaService[] = [
  ...
  },
  {
    ...
    title: "ED Visa",
    titleMM: "ED ဗီဇာ",
    description: "Complete education visa support for language-school programs with school coordination and document prep.",
    descriptionMM: "ဘာသာစကားသင်တန်းများအတွက် school coordination နှင့် document preparation ပါဝင်သော ED visa ဝန်ဆောင်မှုအပြည့်အစုံ။",
    price: 57000,
    priceNote: "Starts from ฿57,000 depending on school package",
    priceNoteMM: "သင်တန်း package အပေါ်မူတည်ပြီး ฿57,000 မှ စတင်သည်",
    duration: "14-30 business days",
    durationMM: "၁၄-၃၀ ရက်",
    icon: GraduationCap,
    featured: true,
    badge: "Long Stay",
    badgeMM: "ရေရှည်နေထိုင်မှု",
    types: ["Language school ED visa", "School coordination", "Document translation checklist"],
    typesMM: ["ဘာသာစကားသင်တန်း ED ဗီဇာ", "School coordination", "စာရွက်စာတမ်း translation checklist"],
  },
  {
    id: "ed-plus-university-visa",
    title: "ED Plus University Visa",
    titleMM: "ED Plus တက္ကသိုလ် ဗီဇာ",
    description: "University-based ED Plus visa support with admissions coordination, document prep, and longer-term study planning.",
    descriptionMM: "တက္ကသိုလ် admission coordination, document preparation နှင့် ရေရှည်ပညာသင်အစီအစဉ်များပါဝင်သော ED Plus university visa ဝန်ဆောင်မှု။",
    price: 57000,
    priceNote: "Starts from ฿57,000, final quote depends on university program",
    priceNoteMM: "฿57,000 မှ စတင်ပြီး တက္ကသိုလ် program အပေါ်မူတည်၍ quote သတ်မှတ်သည်",
    duration: "21-45 business days",
    durationMM: "၂၁-၄၅ ရက်",
    icon: Landmark,
    featured: true,
    badge: "University",
    badgeMM: "တက္ကသိုလ်",
    types: ["University enrollment support", "ED Plus route", "Long-term academic visa planning"],
    typesMM: ["တက္ကသိုလ် enrollment support", "ED Plus လမ်းကြောင်း", "ရေရှည် academic visa planning"],
  },
  {
    id: "marriage-visa",
